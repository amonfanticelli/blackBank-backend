...
exports.createTables1668468302063 = void 0;
class createTables1668468302063 {
    constructor() {
        this.name = 'createTables1668468302063';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "username" character varying NOT NULL, "password" character varying NOT NULL, "accountId" uuid, CONSTRAINT "REL_42bba679e348de51a699fb0a80" UNIQUE ("accountId"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
...
exports.createTables1668468302063 = createTables1668468302063;
//# sourceMappingURL=1668468302063-createTables.js.map